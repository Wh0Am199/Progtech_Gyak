...
public class Main {
    ...
    public static void main(String[] args) throws InvalidPSUException, InvalidMotherboardException {
        ...
        Laptop laptop = new Laptop(cpu,gpu,mb,psu,ram,screen,ComputerCase.ATX);
        laptop.Build();
        basket.Add(laptop);
